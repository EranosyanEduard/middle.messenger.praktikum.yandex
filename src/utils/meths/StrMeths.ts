...
class StrMeths {
    ...
    /**
     * Преобразовать идентификатор, соответствующий стилю kebab-case, в идентификатор,
     * соответствующий стилю camelCase.
     * @param str исходная строка.
     * @returns
     */
    ...
    /**
     * Заменить в строке str пробельные символы, соответствующую регулярному выражению /\s+/g,
     * на строку alt.
     * @param str исходная строка.
     * @param alt значение, которое используется в качестве альтернативы пробельным символам.
     * @returns
     */
